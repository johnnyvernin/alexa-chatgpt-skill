...
const agoraUTC3 = new Date(agora.getTime() - 3 * 60 * 60 * 1000);
const dataStr = agoraUTC3.toLocaleString();
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Olá, eu sou o Bobe, manda a pergunta!';
        ...
        try {
            response = await axios.post('https://api.openai.com/v1/chat/completions', {
                ...
                messages: [
                    ...
                    {
                        role: "user",
                        content: "Responda direto ao ponto em 1 parágrafo: " + question
                    }
                ],
                temperature: 1
            }, {
            ...
            return handlerInput.responseBuilder
                .speak(`Desculpe, ocorreu um erro ao obter a resposta: ${errorMessage}. Por favor, tente novamente.`)
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Esta skill comunica com a API da OpenAI utilizando o modelo ChatGPT Turbo.. ?';
...
const ErrorHandler = {
    ...
    handle(handlerInput, error) {
        const speakOutput = `Desculpe, ocorreu um erro: ${error.message}. Tente de outra forma.`;
